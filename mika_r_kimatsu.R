...
#Q8-1 dataframeのtotal_fertility_rateが求める相関係数の値である。そこから、北九州では新設住宅着工戸数、福岡では有配偶率、筑後は第２子の出生率、筑豊は第１子の出生率が合計特殊出生率と相関が高いことがわかる
#Q8-2 有配偶率も同様にして求められる。dataframeから、北九州は第２子の出生率、福岡では合計特殊出生率、筑後では新設住宅着工戸数、筑豊では市町村民所得が相関が高い
